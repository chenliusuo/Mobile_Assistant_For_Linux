...
#define CMD_RECV_MESSAGE 0x11		//获取未读短信
#define CMD_CONNECT_BREAK 0x12		//连接中断
...
//发送文件上限值
#define FILE_PATH_LEN 60            //文件路径长度(android端/data/data/com.android.ass,PC端/tmp/ass)
#define BUF_SIZE 4096               //发送文件时,定义缓冲区大小
